export default [
    {
      type: 'Humlan P',
      imageUri: require('../assets/headphones/urbanears_blue.png'),
    ...
    {
      type: 'Pampas',
      imageUri: require('../assets/headphones/urbanears_pink.png'),
    ...
    {
      type: 'Humlan P',
      imageUri: require('../assets/headphones/urbanears_grey.png'),
    ...
    {
      type: 'Humlan B',
      imageUri: require('../assets/headphones/urbanears_mint.png'),
      heading: 'From Sweden',
      description:
